...
server = function(input, output, session) {
  ...
  observeEvent(input$gene_spliceai_brush, {
    session$resetBrush("gene_dbscsnv_brush")
  ...
  output$sqtl_candidate_tbl = DT::renderDataTable({
    rv$select_sqtl_candidate[, colnames(rv$select_sqtl_candidate) %in%  c("SubjectID", "Coordinates_of_novel_junc", "Event", "DNA_variant", "SpliceAI", "SpliceAI_pred_match_junction", "dbscSNV", "AF", "SpliceAI_pred_cryptic_exon", "Hotspot")]
