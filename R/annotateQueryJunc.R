#' Annotate query junctions
#'
#' @param query_junc string BED file containing the coordinates of query junctions to be annotated.
...
annotateQueryJunc <-
  function(query_junc, 
    ...
    junc_map = annotateJunc_(query_junc, gene_ref, ensembl_pos, protein_coding_gene, intron_coding, intron_noncoding, addition_annotation)
    
    output_file = gzfile(sprintf("%s_query_junc_anno.txt.gz", output_prefix), 'w')
