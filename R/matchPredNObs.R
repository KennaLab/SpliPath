...
#' @param spliceai_table_name string The table of SpliceAI predictions in the GDB database
...
#'
matchPredNObs <-
function(gdb_path, cohort_name, var2junc, min_spliceai_score, spliceai_table_name, max_skip_exon = 2, reference = "Default", spliceai_default_reference = FALSE){
  ...
  spliceai = rvat::getAnno(mygdb, VAR_id=var2junc$VAR_id, table=spliceai_table_name)
