...
#' @param min_spliceai_score numeric The min splice score of the prediction tools to nominate rare sQTL candidate. The predictions of splice sites that score higher than the min score will be matched with observed junctions.
